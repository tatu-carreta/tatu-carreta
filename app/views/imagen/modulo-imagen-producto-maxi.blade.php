...
<!--Campos ficticios para enmascarar el file-->
        ...
        <span>
            <input type="file" name="imagen_producto" data-previewer='#img_principal' class='oculto file imagen' data="1" required="true">
        </span>
        </label>
...
<!-- fin -->
        ...
        <input class="block anchoTotal marginBottom" type="text" name="epigrafe_imagen_producto" placeholder="Ingrese una descripción de la foto">
</div>
